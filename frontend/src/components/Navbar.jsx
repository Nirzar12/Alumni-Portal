...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-600 text-white shadow-md px-6 py-3">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        {/* Logo */}
        <Link to="/app" className="text-2xl font-bold text-white hover:text-blue-400">
          Alumni-Portal
        </Link>
        ...
        <div className="space-x-6 text-sm md:text-base">
          {user && (
            <>
              <Link to="/app/alumni" className="hover:text-blue-400">
                Alumni
              </Link>
              <Link to="/app/events" className="hover:text-blue-400">
                Events
              </Link>
            </>
          )}
          <Link to="/app/contact" className="hover:text-blue-400">
            Contact
          </Link>
          <Link to="/app/about" className="hover:text-blue-400">
            About Us
          </Link>
        </div>
        ...
        {/* Auth Buttons */}
         <div>
          {user ? (
            <div className="flex items-center space-x-4">
              <span className="text-sm hidden sm:inline text-gray-300">
                {user?.email}
              </span>
              <button
                onClick={handleLogout}
