...
//         try {
//           const response = await axios.post("http://localhost:5050/api/users/register", data, {
//             headers: {
...
//             (message.includes("E11000") || message.includes("duplicate key") || message.includes("enrollment"))
//           ) {
//             toast.error("Enrollment number already exists!");
//           } else if (message.includes("User already exists") || message.includes("email")) {
